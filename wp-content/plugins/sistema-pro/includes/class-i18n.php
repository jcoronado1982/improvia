...
class SOP_I18n {
    ...
    public function translate_strings( $translated_text, $text, $domain ) {
        ...
        $en_dict = array(
            ...
            'Fases de juego a dominar' => 'Game phases to master',
            'Fase Ofensiva' => 'Offensive phase',
            'Fase Defensiva' => 'Offensive phase',
            // AJAX Messages
            'Guardando...' => 'Saving...',
            ...
            'REPORTE MÉDICO / ESPECIALISTA' => 'MEDICAL / SPECIALIST REPORT',
            'Periodo' => 'Period',
            'Semanal' => 'Weekly',
            'Mensual' => 'Monthly',
            ...
            'Resultados en 2 días' => 'Results in 2 days',
            'Escribe aquí tu descripción profesional...' => 'Write your professional description here...',
            'RRSS' => 'SOCIAL MEDIA',
            // Validation messages
